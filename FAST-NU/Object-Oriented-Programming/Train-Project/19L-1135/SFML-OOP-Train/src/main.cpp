...
string WaitB(){
	string Pic;
	string BB2 = "BB2.jpg",BB4 = "BB4.jpg",BB6 = "BB6.jpg";
	int i=Random(1,3);
	if(i==1){
		Pic=BB2;
	}else if(i==2){
...
int main() {
	...
	sf::RenderWindow window(sf::VideoMode(1368, 705), "Train");
	...
	string SPic[5] = {"Saving Data", "Saving Data.", "Saving Data..", "Saving Data...", "Saving Data...."};
	sf::Text saving(SPic[0], loadingFont, 20);
	saving.setPosition(
			static_cast<double>(6 + logo.getPosition().x) + static_cast<double>(logo.getRadius()) * 2.1,
			window.getSize().y - logo.getRadius() - 13);
...
//=====================================================================================================================
	...
	button[0]->getRenderer()->setTextureDown(BS1);
	...
	button[2]->setPosition(window.getSize().x - 150 * 2 - 960 + 30, window.getSize().y - 300);
	button[2]->getRenderer()->setTexture(BS3);
	button[2]->getRenderer()->setTextureHover(BS3);
	button[2]->getRenderer()->setTextureDown(BS3);
	...
	button[3]->setPosition(window.getSize().x - 150 * 2 - 555 + 40, window.getSize().y - 300);
	button[3]->getRenderer()->setTexture(BS4);
	button[3]->getRenderer()->setTextureHover(BS4);
	button[3]->getRenderer()->setTextureDown(BS4);
	...
	button[4]->getRenderer()->setTextureDown(BS5);
	...
	button[5]->getRenderer()->setTextureDown(BS6);
	...
	button[6]->getRenderer()->setTextureDown(BS7);
	...
	button[7]->setPosition(window.getSize().x - 150 * 2 - 960 + 30, window.getSize().y - 300);
	button[7]->getRenderer()->setTexture(BS8);
	button[7]->getRenderer()->setTextureHover(BS8);
	button[7]->getRenderer()->setTextureDown(BS8);
	button[7]->connect("pressed", [&]() {
		button[7]->getRenderer()->setTextureHover(BS8);
		gui.removeAllWidgets();
		T.ViewBogie(window, gui);
		gui.removeAllWidgets();
		button[7]->getRenderer()->setTextureHover(BS8);
		button[7]->getRenderer()->setTextureDown(BS8);
	});
	...
	button[8]->setPosition(window.getSize().x - 150 * 2 - 555 + 40, window.getSize().y - 300);
	button[8]->getRenderer()->setTexture(BS9);
	button[8]->getRenderer()->setTextureHover(BS9);
	button[8]->getRenderer()->setTextureDown(BS9);
	...
	button[9]->getRenderer()->setTextureDown(BS10);
	...
	button[10]->setPosition(window.getSize().x - 150 * 2 - 960 + 30, window.getSize().y - 300);
	button[10]->getRenderer()->setTexture(BS11);
	button[10]->getRenderer()->setTextureHover(BS11);
	button[10]->getRenderer()->setTextureDown(BS11);
	button[10]->connect("pressed", [&]() {
		button[10]->getRenderer()->setTextureHover(BS11);
		gui.removeAllWidgets();
		T.viewPassengers();
		button[10]->getRenderer()->setTextureHover(BS11);
	...
	button[11]->setPosition(window.getSize().x - 150 * 2 - 555 + 40, window.getSize().y - 300);
	button[11]->getRenderer()->setTexture(BS12);
	button[11]->getRenderer()->setTextureHover(BS12);
	button[11]->getRenderer()->setTextureDown(BS12);
	button[11]->connect("pressed", [&]() {
		button[11]->getRenderer()->setTextureHover(BS12);
		gui.removeAllWidgets();
		T.addPassengers();
		button[11]->getRenderer()->setTextureHover(BS12);
	...
	button[12]->getRenderer()->setTextureDown(BS13);
	button[12]->connect("pressed", [&]() {
		button[12]->getRenderer()->setTextureHover(BS13);
		gui.removeAllWidgets();
		T.removePassengers();
		button[12]->getRenderer()->setTextureHover(BS13);
